...
module.exports = function (/** @type {import('plop').NodePlopAPI} */ plop) {
  ...
  plop.setHelper('isEquals', (/** @type {any} */ arg1, /** @type {any} */ arg2) => (
    arg1 === arg2
  ));
  ...
  plop.setGenerator('api', {
    ...
    prompts: [
      { type: 'input', name: 'name', message: 'Graphql service name' }
    ],
    actions: [
      {
        type: 'add',
  ...
  plop.setGenerator('component', {
    ...
    actions: (answers) => {
      ...
      if(answers && answers.type === 'FULL') { _actions.push(_createContainer); _actions.push(_createContent); }
      else { _actions.push(_createMain); }
      _actions.push(_createModel);
      if(answers && answers.withStyle) { _actions.push(_createStyle); }
      if(answers && answers.withService) { _actions.push(_createService); }
  ...
  plop.setGenerator('feature', {
    ...
    actions: (answers) => {
      const _createIndex = {
        type: 'add',
        templateFile: './feature/entity/index.tsx.hbs',
        path: `${ SRC_DIRECTORY }/features/{{kebabCase name}}/index.tsx`
      }

      const _createContainer = {
        type: 'add',
        templateFile: './feature/entity/name.container.tsx.hbs',
        path: `${ SRC_DIRECTORY }/features/{{kebabCase name}}/{{kebabCase name}}.container.tsx`
      }

      const _createContent = {
        type: 'add',
        templateFile: './feature/entity/name.content.tsx.hbs',
        path: `${ SRC_DIRECTORY }/features/{{kebabCase name}}/{{kebabCase name}}.content.tsx`
      }
      
      const _createModel = {
        type: 'add',
        templateFile: './feature/entity/name.model.tsx.hbs',
        path: `${ SRC_DIRECTORY }/features/{{kebabCase name}}/{{kebabCase name}}.model.tsx`
      }
      
      const _createStyle = {
        type: 'add',
        templateFile: './feature/entity/name.module.css.hbs',
        path: `${ SRC_DIRECTORY }/features/{{kebabCase name}}/{{kebabCase name}}.module.css`
      }
      
      const _createService = {
        type: 'add',
        templateFile: './feature/entity/name.service.graphql.hbs',
        path: `${ SRC_DIRECTORY }/features/{{kebabCase name}}/{{kebabCase name}}.service.graphql`
      }

      const _createReadme = {
        type: 'add',
        templateFile: './feature/entity/README.md.hbs',
        path: `${ SRC_DIRECTORY }/features/{{kebabCase name}}/README.md`
      }
      
      const _createBarrel = {
        type: 'add',
        skipIfExists: true,
        templateFile: './feature/index.tsx.hbs',
      ...
      const _createUnitSpec = {
        type: 'add',
        skipIfExists: true,
        templateFile: './_test-spec/feature.spec.ts.hbs',
        path: `${ PROJECT_ROOT }/e2e/specs/{{kebabCase name}}.spec.ts`
      }
  ...
  plop.setGenerator('function', {
    ...
    actions: [
      {
        type: 'add',
        templateFile: './function/entity/index.tsx.hbs',
      ...
      },
      {
        ...
        templateFile: './function/index.tsx.hbs'
      },
      {
        type: 'append',
        unique: true,
  ...
  plop.setGenerator('hook', {
    ...
    prompts: [
      { type: 'input', name: 'name', message: 'Hook name' }
    ],
    actions: [
      {
        type: 'add',
        templateFile: './hook/entity/index.tsx.hbs',
      ...
      },
      {
        ...
        templateFile: './hook/index.tsx.hbs'
      },
      {
        type: 'append',
        unique: true,
  ...
  plop.setGenerator('store', {
    ...
    actions: (answer) => {
      ...
      const _createIndex = {
        type: 'add',
        templateFile: './store/entity/atom/index.tsx.hbs',
      ...
      const _createLocalBarrel = {
        ...
        templateFile: './store/entity/index.tsx.hbs'
      }
      ...
      _actions.push(_createModel);
      if(answer && answer.withSelector) { _actions.push(_createSelector); }
  ...
  plop.setGenerator('variable', {
    ...
    actions: [
      {
        type: 'add',
        templateFile: './variable/entity/index.tsx.hbs',
      ...
      },
      {
        ...
        templateFile: './variable/index.tsx.hbs'
      },
      {
        type: 'append',
        unique: true,
